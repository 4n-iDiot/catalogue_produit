...
return $this->privates['fidry_alice_data_fixtures.doctrine.persister_loader'] = new \Fidry\AliceDataFixtures\Loader\PersisterLoader($this->load('getFidryAliceDataFixtures_Loader_SimpleService.php'), ($this->services['fidry_alice_data_fixtures.persistence.persister.doctrine'] ?? $this->load('getFidryAliceDataFixtures_Persistence_Persister_DoctrineService.php')), ($this->privates['monolog.logger'] ?? $this->load('getMonolog_LoggerService.php')), []);
