...
return new \Fidry\AliceDataFixtures\Loader\SimpleLoader(($this->services['nelmio_alice.files_loader'] ?? $this->load('getNelmioAlice_FilesLoaderService.php')), ($this->privates['monolog.logger'] ?? $this->load('getMonolog_LoggerService.php')));
